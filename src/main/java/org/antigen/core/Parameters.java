...
public class Parameters {
  ...
  public static boolean tipSamplingProportional =
      true; // whether to sample proportional to prevalance
  public static double treeProportion = 0.1; // proportion of tips to use in tree reconstruction
  public static int diversitySamplingCount =
      1000; // how many samples to draw to calculate diversity, Ne*tau, serial
  // interval
  ...
  public static boolean immunityReconstruction =
      false; // whether to print immunity reconstruction to out.immunity
  ...
  public static boolean reducedOutput =
      false; // whether to output only out.summary and out.timeseries
  public static boolean detailedOutput =
      false; // whether to output out.hosts and out.viruses files enabling
  // checkpointing
  ...
  public static int fitnessSampleSize =
      10000; // number of random hosts to sample for average infection risk
  ...
  // host parameters
  public static double birthRate =
      0.000091; // in births per individual per day, 1/30 years = 0.000091
  public static double deathRate =
      0.000091; // in deaths per individual per day, 1/30 years = 0.000091
  ...
  public static String phenotypeSpace =
      "geometric"; // options include: "geometric", "geometric3d", "geometric10d"
  ...
  public static double waningRate =
      0.01; // rate per day of a host removing a random phenotype from their immune
  // history
  ...
  public static double homologousImmunity =
      0.05; // immunity raised to antigenically identical virus
  ...
  public static double proportionHighSites =
      0.2; // proportion of epitope sites that are high in mutation step size distribution
  ...
  public static String DMSFile =
      null; // name of DMS csv file: must have 21 columns (site number and amino acid
  // preferences ordered alphabetically) and rows must equal the number of
  // amino acid sites in the virus sequence)
  public static double nonEpitopeAcceptance =
      1.0; // probability of accepting a non-epitope mutation
  ...
  public static int[] hostImmunitySamplesPerDeme = {
    100, 100, 100
  }; // number of hosts to sample for immunity
  ...
  public static void load() {
    ...
    try {
      ...
      if (map.get("startingSequence") != null) {
        ...
        if (phenotypeSpace.equals("geometricSeq")) {
          if (startingSequence.length() == 0 || startingSequence.length() % 3 != 0) {
            System.out.println(
                "startingSequence length should be any multiple of 3, except for 0.");
      ...
      // Here, define low and high sites based on a user-defined parameter called
      // "proportionHighSites"
      ...
      if (map.get("DMSFile") != null) {
        ...
        Scanner DMSData =
            new Scanner(Parameters.class.getClassLoader().getResourceAsStream(Parameters.DMSFile));
      ...
      if (map.get("hostImmunitySamplesPerDeme") != null) {
        hostImmunitySamplesPerDeme =
            toIntArray((List<Integer>) map.get("hostImmunitySamplesPerDeme"));
      }
  ...
  private static String readStartingSequenceFile(String startingSequenceFile)
      throws FileNotFoundException {
    // Parse the fasta file to get a sequence of nucleotides
    StringBuilder startingSequenceSB = new StringBuilder();
    Scanner startingSequenceScanner =
        new Scanner(Parameters.class.getClassLoader().getResourceAsStream(startingSequenceFile));
  ...
  private static int[] readEpitopeSitesFile(String epitopeSitesFile) throws FileNotFoundException {
    Scanner epitopeSitesScanner =
        new Scanner(Parameters.class.getClassLoader().getResourceAsStream(epitopeSitesFile));
    // Q for @thienktran: What if there are multiple lines? Should I make a note in the README to
    // not have any new line characters in the file?
